...
REGISTER_SAFE_FUNCTION(System, regex_submatch, &ScriptUtils::RegexSubmatch, "pattern:text");
...
Array::Ptr ScriptUtils::RegexSubmatch(const String& pattern, const String& text)
{
	boost::regex expr (pattern.GetData());
	boost::smatch what;
